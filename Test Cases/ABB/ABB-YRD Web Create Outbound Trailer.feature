...
# 
############################################################ 
Feature: ABB-YRD Create Outbound Trailer
...
@BASE-YRD-1040
Scenario Outline: ABB-YRD Web Create Outbound Trailer for Check In
CSV Examples: Test Case Inputs/ABB-YRD-1040.csv

Given I "execute pre-test scenario actions (including pre-validations)"
	And I execute scenario "Begin Pre-Test Activities"

Then I execute scenario "Web Login NP2"
