...
############################################################ 
# Test Case: ABB-INV-04 Move Inventory.feature
#
...
#
# Input Source: Test Case Inputs/ABB INPUTS/ABB-INV-04.csv
# Required Inputs:
...
#
############################################################ 
Feature: ABB-INV-04 Move Inventory NP5
...
Given I "setup the environment"
	...
	And I assign "ABB-INV-04" to variable "test_case"
...
@ABB-INV-04
Scenario Outline: ABB-INV-04 Move Inventory
CSV Examples: Test Case Inputs/ABB Inputs NP5/ABB-INV-04.csv
...
Then I execute scenario "Web Inventory Move"
