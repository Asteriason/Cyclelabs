...
#
############################################################
Feature: ABB-RCV-03 Receive Inbound Shipment NP5
...
CSV Examples: Test Case Inputs/ABB INPUTS NP5/ABB-RCV-03.csv
...
When I "open the Receipt, process workflow, receive each receipt line individually, and deposit to location"
    ...
    Then I execute scenario "Mobile Receiving Wrong Item"
