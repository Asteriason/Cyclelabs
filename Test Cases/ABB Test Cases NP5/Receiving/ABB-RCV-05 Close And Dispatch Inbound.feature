...
#
############################################################ 
Feature: ABB-RCV-05 Close And Dispatch NP5
...
Given I "setup the environment"
	...
	Then I assign "ABB-RCV-05" to variable "test_case"
	When I execute scenario "Test Data Triggers"

	And I assign $trlr_num to variable "trknum"
    And I assign "FALSE" to variable "auto_close_flag"

	Then I assign "nsifuwf" to variable "recovery_deploc"
After Scenario: 
#############################################################
...
CSV Examples: Test Case Inputs/ABB INPUTS NP5/ABB-RCV-05.csv
