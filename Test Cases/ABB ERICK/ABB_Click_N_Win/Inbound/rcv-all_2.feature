...
#
# Description:
#   It's doing the general receipt process.	Validate Move Inventory Before OSD Closure.
#
...
#
############################################################
Feature: ABB-RCV-08 Move Inventory Before OSD
    ...
    Background:
        ...
        Then I assign "ABB-RCV-08" to variable "test_case"
    ...
    @ABB-RCV-08
    Scenario Outline: Move Before Inventory OSD Closure and Validations
        CSV Examples: Test Case Inputs\ABB_Click_N_Win\Inbound\rcv_all.csv

        Given I "execute pre-test scenario actions (including pre-validations)"
        And I execute scenario "Begin Pre-Test Activities"

        Then I "check if we need to run this test"
        When I execute scenario "Validate Move Inventory Before OSD Closure"
        And I execute scenario "Validate Over Receiving"
        And I execute scenario "Validate Unexpected Item"
