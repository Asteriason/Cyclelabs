...
#
############################################################
Feature: ABB-RCV-Mobile Inbound Receiving.feature
...
@ABB-RCV-03
Scenario Outline: ABB-RCV-Mobile Inbound Receiving
CSV Examples: Test Case Inputs/ABB INPUTS/ABB-RCV-03.csv
...
And I "verify variable to complete the receiving process"
While I verify variable "receive_more_flag" is assigned
		And I wait $wait_short seconds
        Given I "See True flag - line of inventory"
        if I verify text $receive_more_flag is equal to "0" 
        And  I "move to Product Putaway screen and process the Putaway"
             ...
             And I "deposit the load"
                    ...
                    Then I unassign variable "receive_more_flag"
                    And I press keys "F1" in app
		Endif 
          Given I "See False flag = last line in order"
        if I verify text $receive_more_flag is equal to "1"
        And  I "move to Product Putaway screen and process the Putaway"
        Then I execute scenario "Mobile Trigger Product Putaway"
        And I execute scenario "Mobile Process Product Putaway"
And I "deposit the load"
