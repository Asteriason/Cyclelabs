...
#
############################################################ 
Feature: ABB-PCK-08 Outbound Mobile Pick Directed
...
Given I "setup the environment"
    ...
    And I assign "PCK" to variable "oprcod"
    Then I assign "001-008-B-B-267" to variable "mobile_start_loc"
    # LPCK=PJ  PCK=RT
    Then I assign "HH" to variable "vehtyp"
...
@ABB-PCK-08
Scenario Outline: ABB-PCK-08 Outbound Mobile Pick Directed
CSV Examples:Test Case Inputs/ABB INPUTS/ABB-PCK-08P.csv
