...
############################################################ 
# Test Case: ABB-WAV-12 Outbound Load Equipment.feature
# 
...
# 
# Input Source: Test Case Inputs/ABB INPUTS/ABB-WAV-12.csv
# Required Inputs:
...
#
############################################################ 
Feature: ABB-WAV-12 Outbound Load Equipment
...
Given I "setup the environment"
	...
	And I assign "ABB-WAV-12" to variable "test_case"
	When I execute scenario "Test Data Triggers"
	And I assign "Yes" to variable "modifyLoad"
	
Then I "delete the empty stop"
	#When I execute scenario "Delete Stop with Ordnum_1"
After Scenario:
#############################################################
...
@ABB-WAV-12
Scenario Outline: ABB-WAV-12 Web Outbound Load Equipment
CSV Examples: Test Case Inputs\ABB INPUTS\LTL-MTOL-ALL.csv
#CSV Examples: Test Case Inputs\ABB INPUTS\ABB-WAV-12.csv
...
And I "navigate to the load screen"
	...
	Then I execute scenario "Web Validate Load Info NP5 For 2 Stops"
