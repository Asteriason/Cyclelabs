...
#
############################################################ 
Feature: ABB-PCK-08 Outbound List Pick Directed NP6
...
CSV Examples:Test Case Inputs/ABB INPUTS NP6/ABB-PCK-08L.csv
...
When I "perform verify the type of pick and perform the pick"
	If I verify text $oprcod is equal to "CHANNELWA"
