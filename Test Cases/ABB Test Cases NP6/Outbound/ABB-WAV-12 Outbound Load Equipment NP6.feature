...
#
############################################################ 
Feature: ABB-WAV-12 Outbound Load Equipment NP6
...
CSV Examples: Test Case Inputs/ABB INPUTS NP6/ABB-WAV-12.csv
...
And I "navigate to the load screen"
	...
	Then I execute scenario "Web Validate Load Info"
